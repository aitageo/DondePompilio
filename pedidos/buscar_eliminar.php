...
<body>
    ...
    <div class="contenedor">
        ...
        <form action="" method="post">
            <input type="text" id="numero_cedula" name="pedido" placeholder="Numero de pedido" max="1">   
             <div class="buscar">
            <div class="btn-group">
   ...
   <!-- <a href="cerrar_sesion.php" style="color: blue; margin-left:40px">Cerrar sesion</a>
    <input type="button" onclick="history.back()" name="volver atrás" value="volver atrás" id="atras">
