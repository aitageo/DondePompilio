...
<body>
        ...
        <form action="" method="post">
          ...
          <div class="btn-group">
                <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
                  <button type="submit" class="btn btn-primary" name="nuevo" formaction="clientes/insertar.php" id="nuevo">Nuevo</button>
    ...
    <input type="button" onclick="window.location.href= 'clientes/buscar_eliminar.php'" name="Eliminar" value="Eliminar y buscar" id="eliminar_usuario" class="clientes">
