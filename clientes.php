        ...
        <form action="" method="post">
          ...
          <div class="btn-group">
                <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
                  <button type="submit" class="btn btn-primary" name="nuevo" formaction="clientes/insertar.php" id="nuevo"onClick="validarUsuario();">Nuevo</button>
                  <button type="submit" class="btn btn-primary" name="actualizar" formaction="clientes/actualizar.php" id="actualizar">Actualizar</button>
                  <button type="submit" class="btn btn-danger" name="eliminar" formaction="clientes/eliminar.php" id="eliminar">Eliminar</button>
                  <button type="submit" class="btn btn-primary" name="buscar" formaction="clientes/buscar.php" id="buscar">Buscar</button>
           </div> 
        </form>
    </div>
