        ...
        <form action="" method="post">
            ...
            <div class="btn-group">
                <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
                  ...
                  <button type="submit" class="btn btn-danger" name="eliminar" formaction="./modal/eliminar.php" id="eliminar">Eliminar</button>
                  <button type="submit" class="btn btn-primary" name="buscar" formaction="./modal/buscar.php" id="buscar">Buscar</button>
           </div>  
        </form>
    </div>
